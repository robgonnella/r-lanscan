...
generate-dot-env:
    AIR_GAPPED="${AIR_GAPPED:-false}" && echo "AIR_GAPPED=${AIR_GAPPED}" > .env
...
exec-workspace-term *args: up
    docker compose exec workspace /workspace/target/debug/r-lanterm {{ args }}
